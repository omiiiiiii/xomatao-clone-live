...
const tabOption = ({activeTab ,setactiveTab}) => {
  ...
  return (
   <div className='tab-option'>
     <div className='max-width option-wrapeer'>
       {
         tabs.map((tab)=>{
           return <div key={tab.id} onClick={()=>setactiveTab(tab.name)} className={`tab-item abolute-center cur-po ${activeTab===tab.name && "active-tab"}`}>
              <div className='tab-img-container abolute-center' style={{ backgroundColor: `${
